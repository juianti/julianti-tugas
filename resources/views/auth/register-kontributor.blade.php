...
<body>
  <div class="container mt-5">
    <h2 class="mb-4">Register as Kontributor</h2>
    <form action="{{ url('registrasi/kontributor') }}" method="post">
      ...
      <button type="submit" class="btn btn-success">Register as Kontributor</button>
    </form>
  </div>
